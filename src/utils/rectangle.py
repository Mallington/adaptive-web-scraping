import itertools
# Taken from: https://stackoverflow.com/questions/25068538/intersection-and-difference-of-two-rectangles
class Rectangle:
    ...
    def intersect(self,other):
        ...
        print(f"{self.x1}, {self.y1}, {self.x2}, {self.y2} intersect with {other.x1}, {other.y1}, {other.x2}, {other.y2}")

        if self.x1 == self.x2 or self.y1 == self.y2 or other.x1 == other.x2 or other.y1 == other.y2:
            return False
